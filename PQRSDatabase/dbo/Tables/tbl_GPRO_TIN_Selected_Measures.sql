CREATE TABLE [dbo].[tbl_GPRO_TIN_Selected_Measures] (
    ...
    [Is_Active]               BIT          CONSTRAINT [default_tbl_GPRO_TIN_Selected_Measures_Is_Active] DEFAULT ((1)) NULL,
    [Is_90Days]               BIT          CONSTRAINT [default_tbl_GPRO_TIN_Selected_Measures_Is_90Days] DEFAULT ((0)) NOT NULL,
    [UpDatedFrom]             VARCHAR (50) NULL,
    [isEndToEndReported]      BIT          NULL,
    [TotalCasesReviewed_C2]   INT          NULL,
    [HundredPercentSubmit_C2] BIT          NULL,
    CONSTRAINT [PK_tbl_GPRO_TIN_Selected_Measures] PRIMARY KEY CLUSTERED ([Measure_num] ASC, [Submission_year] ASC, [TIN] ASC)
);
