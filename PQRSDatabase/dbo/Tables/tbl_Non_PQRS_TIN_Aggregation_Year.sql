CREATE TABLE [dbo].[tbl_Non_PQRS_TIN_Aggregation_Year] (
    ...
    [GPRO]                     BIT             CONSTRAINT [DF_tbl_Non_PQRS_TIN_Aggregation_Year_GPRO] DEFAULT ((0)) NOT NULL,
    [Is_90Days]                BIT             CONSTRAINT [default_tbl_Non_PQRS_TIN_Aggregation_Year_Is_90Days] DEFAULT ((0)) NULL,
    [Decile_val]               NVARCHAR (50)   NULL,
    CONSTRAINT [PK_tbl_Non_PQRS_TIN_Aggregation_Year] PRIMARY KEY CLUSTERED ([Aggregation_Id] ASC)
);
