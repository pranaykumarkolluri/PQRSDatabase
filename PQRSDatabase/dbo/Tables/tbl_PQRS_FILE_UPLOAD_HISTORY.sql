CREATE TABLE [dbo].[tbl_PQRS_FILE_UPLOAD_HISTORY] (
    ...
    [UserID]                              INT           NULL,
    [IsFile_Encrypted]                    BIT           CONSTRAINT [DF_tbl_PQRS_FILE_UPLOAD_HISTORY_IsFile_Encrypted] DEFAULT ((0)) NOT NULL,
    [Encryption_Type]                     VARCHAR (50)  NULL,
    [FacilityID]                          VARCHAR (50)  NULL,
    [NRDRUserID]                          NVARCHAR (50) NULL,
    [isFacility]                          BIT           CONSTRAINT [default_isFacility] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK__tbl_PQRS__3214EC2737A5467C] PRIMARY KEY CLUSTERED ([ID] ASC)
);
