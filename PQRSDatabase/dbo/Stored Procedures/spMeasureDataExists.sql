...
-- Author:		HARI J
-- Create date:
-- Description:	used to check measure data exist 
...
-- =============================================
 ...
 CREATE PROCEDURE [dbo].[spMeasureDataExists] 
	(       
...
BEGIN
	...
	set @recordExists = 0;
	declare @ExamId as int
	/*
	if Exists( select 1 from tbl_Exam e   with(nolock) 
	...
	Else 
		...
		select @recordExists as [RecordExists]
		return @@RowCount
