CREATE TABLE [dbo].[tbl_Physician_Selected_Measures_90days] (
    ...
    [Is_Active]               BIT          CONSTRAINT [default_tbl_Physician_Selected_Measures_90days_Is_Active] DEFAULT ((1)) NULL,
    [Is_90Days]               BIT          CONSTRAINT [default_tbl_Physician_Selected_Measures__90days_Is_90Days] DEFAULT ((1)) NULL,
    [UpDatedFrom]             VARCHAR (50) NULL,
    [isEndToEndReported]      BIT          NULL,
    [TotalCasesReviewed_C2]   INT          NULL,
    [HundredPercentSubmit_C2] BIT          NULL,
    CONSTRAINT [PK_tbl_Physician_Selected_Measures_90days] PRIMARY KEY CLUSTERED ([Phy_Sel_Measure_ID] ASC)
);
