CREATE TABLE [dbo].[tbl_Physician_Aggregation_Year] (
    ...
    [Exclusion]                INT             CONSTRAINT [DF_tbl_Physician_Aggregation_Year_Exclusion_1] DEFAULT ((0)) NOT NULL,
    ...
    [GPRO]                     BIT             CONSTRAINT [DF_tbl_Physician_Aggregation_Year_GPRO] DEFAULT ((0)) NULL,
    [Decile_Val]               VARCHAR (50)    NULL,
    [Is_90Days]                BIT             CONSTRAINT [default_tbl_Physician_Aggregation_Year_Is_90Days] DEFAULT ((0)) NULL,
    [TotalExamsCount]          INT             NULL,
    [Stratum_Id]               INT             NULL,
    [observationInstances]     INT             NULL,
    [Criteria]                 VARCHAR (100)   NULL,
    CONSTRAINT [PK_tbl_Physician_Aggregation_Year] PRIMARY KEY CLUSTERED ([Aggregation_Id] ASC)
);
