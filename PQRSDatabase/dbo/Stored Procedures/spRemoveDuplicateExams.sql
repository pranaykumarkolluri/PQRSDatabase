...
--Change #1:JIRA#622
--Change #2:Exam_Unique_ID varchar size increased varchar(100) to varchar(500)
-- =============================================
CREATE PROCEDURE [dbo].[spRemoveDuplicateExams] 
...
declare @exam_unique_id  as varchar(500)        ----Change #2
...
IF OBJECT_ID('tempdb..#tmp_dup') IS NOT NULL
    DROP TABLE #tmp_dup
		...
		select  top 1000 physician_npi, exam_tin, patient_id, patient_age, patient_gender, exam_date, measure_id,
