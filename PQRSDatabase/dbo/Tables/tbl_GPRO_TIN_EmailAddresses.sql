CREATE TABLE [dbo].[tbl_GPRO_TIN_EmailAddresses] (
    ...
    CONSTRAINT [PK_tbl_GPRO_TIN_EmailAddresses] PRIMARY KEY CLUSTERED ([id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_tbl_GPRO_TIN_EmailAddresses]
    ON [dbo].[tbl_GPRO_TIN_EmailAddresses]([GPROTIN] ASC, [GPROTIN_EmailAddress] ASC);
