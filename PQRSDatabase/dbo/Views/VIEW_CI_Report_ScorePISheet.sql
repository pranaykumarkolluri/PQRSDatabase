...
-- Description: PQRS-924: A view to show the total PI score for  TIN and TIN/NPI submission.  
-- =============================================

CREATE VIEW [dbo].[VIEW_CI_Report_ScorePISheet]
AS
   SELECT DISTINCT
       A.Exam_TIN,
...
FROM tbl_Physician_Aggregation_Year P
     INNER JOIN tbl_TIN_GPRO TG ON P.Exam_TIN = TG.TIN
                                   AND TG.is_GPRO = 0
     LEFT JOIN tbl_ACI_Users G ON G.TIN = P.Exam_TIN
